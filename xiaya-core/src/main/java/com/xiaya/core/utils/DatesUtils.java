...
//				int sc = (int) (remaining % 60);
    ...
    public static void main(String[] args) throws ParseException, DateParseException {
        ...
        String lastUpdateTime = DatesUtils.format(addDate(new Date(), -30));
        System.err.println(lastUpdateTime);
        int duration = 15;
        String compareTime = DatesUtils.format(addDate(new Date(), -duration));
        System.err.println(compareTime);
        System.err.println(DatesUtils.parseIfBlank(compareTime).after(DatesUtils.parseIfBlank(lastUpdateTime)));
